...
<Package name="Survey" format_version="4">
    ...
    <Dialogs>
        ...
        <Dialog name="question_1" src="question_1/question_1.dlg" />
        <Dialog name="question2" src="question2/question2.dlg" />
        <Dialog name="questio3" src="questio3/questio3.dlg" />
    ...
    <Topics>
        ...
        <Topic name="question_1_enu" src="question_1/question_1_enu.top" topicName="question_1" language="en_US" />
        <Topic name="question2_enu" src="question2/question2_enu.top" topicName="" language="" />
        <Topic name="questio3_enu" src="questio3/questio3_enu.top" topicName="" language="" />
        <Topic name="question4_enu" src="question4/question4_enu.top" topicName="" language="" />
        <Topic name="question5_enu" src="question5/question5_enu.top" topicName="" language="" />
        <Topic name="question6_enu" src="question6/question6_enu.top" topicName="" language="" />
    </Topics>
    <IgnoredPaths />
